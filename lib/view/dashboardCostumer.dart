...
class DashboardCosView extends StatefulWidget {
  const DashboardCosView({super.key});

  @override
  State<DashboardCosView> createState() => _DashboardViewState();
}

class _DashboardViewState extends State<DashboardCosView> {
  @override
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => PesanView()),
                              );
                            },
                            child: WidgetMenu(
                              logonya: 'assets/truck.png',
                              NamaMenu: 'Pesan Penjemputan',
                              Subtitle: 'Buat pesanan Penjemputan Anda',
                            ),
                          ),
                          WidgetMenu(
